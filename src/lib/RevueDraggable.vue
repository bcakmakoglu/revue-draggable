...
import { defineComponent, onBeforeUnmount, onMounted, computed, ref, PropType, cloneVNode } from 'vue';
...
const Draggable = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const onDragStart: DraggableEventHandler = (e, coreData) => {
      ...
      dragging.value = true;
      dragged.value = true;
      console.log(dragging.value, dragged.value);
    };
    ...
    const onDrag: DraggableEventHandler = (e, coreData) => {
      ...
      slackX.value = newState.slackX;
      slackY.value = newState.slackY;
    };
    ...
    const children = computed(() => {
      const vSlots = slots.default ? slots.default() : [];
      return vSlots.map((node: any) =>
        cloneVNode(node, {
          ...node.props,
          class: classes.value,
          style: style.value,
